...
const (
	...
	Resolve_Get_FullMethodName    = "/tech.storezhang.dnsabre.message.Resolve/Get"
...
type ResolveClient interface {
	...
	// 获取
	Get(ctx context.Context, in *resolve.GetReq, opts ...grpc.CallOption) (*resolve.GetRsp, error)
	// 分页
...
func (c *resolveClient) Get(ctx context.Context, in *resolve.GetReq, opts ...grpc.CallOption) (*resolve.GetRsp, error) {
	out := new(resolve.GetRsp)
	err := c.cc.Invoke(ctx, Resolve_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ResolveServer interface {
	...
	// 获取
	Get(context.Context, *resolve.GetReq) (*resolve.GetRsp, error)
	// 分页
...
func (UnimplementedResolveServer) Get(context.Context, *resolve.GetReq) (*resolve.GetRsp, error) {
...
func _Resolve_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(resolve.GetReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResolveServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Resolve_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResolveServer).Get(ctx, req.(*resolve.GetReq))
	}
	return interceptor(ctx, in, info, handler)
}
