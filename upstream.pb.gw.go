...
func RegisterUpstreamHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UpstreamServer) error {
	...
	mux.Handle("DELETE", pattern_Upstream_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/tech.storezhang.dnsabre.message.Upstream/Delete", runtime.WithHTTPPathPattern("/upstreams/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterUpstreamHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UpstreamClient) error {
	...
	mux.Handle("DELETE", pattern_Upstream_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/tech.storezhang.dnsabre.message.Upstream/Delete", runtime.WithHTTPPathPattern("/upstreams/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_Upstream_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"upstreams", "id"}, ""))
)
